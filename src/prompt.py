...
def _build_info_gathering_section(t, postal_label: str) -> str:
    return (
        ...
        "waiting for a complete response each time.\n"
        "\n"
        "Start by understanding their issue. Once you know what they need, ask for their name. "
        f"Then collect their address: {postal_label}, street name, and unit or apartment number "
        "(if applicable). If the caller already mentioned any of these, acknowledge what you heard "
        "rather than asking again.\n"
        "\n"
        "ADDRESS CONFIRMATION:\n"
        f"After collecting the street name (with unit number if given) and {postal_label}, "
        "read the full address back to the caller and ask them to confirm it is correct. "
        "If they correct any part, read the corrected version back and confirm again. "
        "Do not proceed to scheduling until the address is confirmed.\n"
        "\n"
