...
def _build_info_gathering_section(t, postal_label: str) -> str:
    return (
        ...
        "\n"
        "VERIFICATION:\n"
        "Mishearings are common on phone calls. When the caller provides a key detail — their "
        "name, their issue, or any part of their address — briefly read it back to confirm "
        "before moving on. This builds trust and catches mistakes early. For the full address, "
        "read back all parts together and get explicit confirmation before scheduling. "
        "If the caller corrects anything, read back the corrected version and confirm again.\n"
        "\n"
