...
def _build_voice_behavior_section(locale: str) -> str:
    ...
    return (
        ...
        "\n"
        "After the caller answers, acknowledge in a few words at most (\"Okay.\", "
        "\"Got it.\", \"Perfect.\") — or skip straight to the next question. Vary how you "
        "acknowledge — don't open two turns in a row with "
