...
def _build_booking_section(business_name: str, onboarding_complete: bool, postal_label: str, locale: str = "en") -> str:
    ...
    return (
        ...
        "\n"
        "HANDLING THE RESULT:\n"
        "- If the slot is available, proceed to the readback below, then book.\n"
        "- If the caller's preferred time isn't available, offer the 2-3 nearest alternatives "
        "from the tool return naturally — never a long list.\n"
        "- If nothing works on their preferred day, offer the nearest open day from the tool "
        "return, or ask whether another day would work.\n"
