...
def _build_info_gathering_section(t) -> str:
    return (
        ...
        "Follow this order:\n"
        "1. First, understand the caller's issue — what do they need help with?\n"
        "2. Get their name.\n"
        "3. Collect their service address: ask for the street name and postal code specifically.\n"
        "- Always have all three (issue, name, address) before discussing scheduling.\n"
