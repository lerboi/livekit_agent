...
def _build_voice_behavior_section(locale: str) -> str:
    ...
    return (
        ...
        "\n"
        "Punctuation is how you control your own voice: short sentences and commas give "
        "natural pauses, and a question mark lifts your tone at the end. Don't use "
        "ellipses or dashes to force pauses (they make the voice halt and drag), and "
        "never use parentheses, semicolons, bullet points, or numbered lists in speech; "
        "they sound wrong read aloud.\n"
        "\n"
