...
# ─────────────────────────────────────────────────────────────────────────────
# (Phase 65) The Gemini-era input-mute + cascade-recovery helpers
# (mute_input_during_tool, _attempt_tool_result_replay, _TOOL_MUTE_FALLBACK_S)
# were removed in the OpenAI gpt-realtime-2 migration. gpt-realtime-2 has
# native async (NON_BLOCKING) function calling, so caller speech no longer
# cancels in-flight tool calls -- there is nothing to mute or replay.
# ─────────────────────────────────────────────────────────────────────────────
